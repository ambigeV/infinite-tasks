...
def get_problem(name, problem_params=None, task_params=2):
    ...
    PROBLEM = {
        ...
        'linear_rastrigin_20_high': Rastrigin(n_dim=problem_params, mode="linear", 
                                              task_param=task_params, factor=40),
        'nonlinear_rastrigin_20_high': Rastrigin(n_dim=problem_params, mode="nonlinear",
                                                 task_param=task_params, factor=40, mean=0, std=1),
        ...
        'linear_griewank_high': Griewank(n_dim=problem_params, mode="linear",
                                            task_param=task_params, factor=800, mean=0, std=1),
